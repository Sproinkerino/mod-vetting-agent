...
function AppShell({ children, action }) {
  return <div className="app-shell"><a className="skip-link" href="#main-content">Skip to content</a><header className="topbar"><a className="logo" href="/" aria-label="RoastReel home"><span>🔥</span> Roast<span>Reel</span></a><p>Receipts before replies.</p>{action}</header>{children}</div>;
}
